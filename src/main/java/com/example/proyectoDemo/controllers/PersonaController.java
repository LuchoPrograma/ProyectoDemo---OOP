package com.example.proyectoDemo.controllers;

import com.example.proyectoDemo.entities.Persona;
import com.example.proyectoDemo.services.PersonaServiceImpl;
...
public class PersonaController {
    ...
    public ResponseEntity<?> getAll() {
        try{
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"error\":\"Error, por favor intente mas tarde.\"}"); //body en formato JSON
        }
    }
